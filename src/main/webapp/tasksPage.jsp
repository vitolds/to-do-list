...
<body>
    ...
    <script type="text/javascript">
        ...
        function editTask(taskId) {
            $.each(jsonObj, function(index, task) {
    ...
    <div class="main-container">
                ...
                <c:forEach items="${data}" var="task">
                    ...
                    <tr>
                        <td colspan="2" class="hiddenRow" style="padding: 0 !important;">
                            <div style="padding: 5 !important;" id="task<c:out value="${task.taskId}"/>" class="collapse"><c:out value="${task.text}"/></div>
                        </td>
                    </tr>
                </c:forEach>
            </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" value="Refresh Page" onClick="window.location.reload()" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        border-radius: 0.3em;">
                            ...
                            <div id="alert"><%= request.getAttribute("data")%></div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="taskPriority" class="form-control" name="taskPriority" style="max-width: 110px;">
                    ...
                    <div class="modal-footer">
                        <button type="button" value="Refresh Page" onClick="window.location.reload()" class="btn btn-default" data-dismiss="modal">Close</button>
